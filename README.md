...
There are two ways to get started: using the PerilsAndPrincesses system generator command or manually renaming and updating files.
...
Head over to the [Vue3PerilsAndPrincesses System](https://gitlab.com/asacolips-projects/foundry-mods/vue3boilerplate) repo if you're interested in using Vue!
